...
4. Collect coins and defeat enemies
5. Reach the flag to complete the level
6. Beat the countdown timer for bonus points
...
This game was created as a rapid development challenge, showcasing core platformer mechanics implemented efficiently in Unity 6. Despite the short timeline, it includes:
- Complete game loop (menu → gameplay → end screen)
